...
> **Note:** The model covers the **power sector only and does not include district heating**. The results presented in the [study](https://www.agora-energiewende.org/publications/cross-border-power-system-integration-in-central-asia) are compatible with PyPSA-SPICE version [v1.1.1](https://agoenergy.github.io/pypsa-spice/releases/#v111-2026-02-24) with hourly resolution.
